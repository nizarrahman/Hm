...
const esce = ('© Nizar Rahman X 𝗕𝗼𝘁 𝗢𝗳𝗳𝗶𝗰𝗶𝗮𝗹 𝗡𝗮𝗶 𝗦𝘁𝗼𝗿𝗲')
...
jumlahharian = `${dataa.value}`
	...
	if (db.data.settings[botNumber].autobio) {
	  ...
	  // Anti Link
        ...
        if (isCreator) return m.reply(`*maaf kamu pengembang Akuu*`)
...
├ Dilarang Membully Bot
├ Dilarang Membully Pembuat Bot 
│
╰────❍`
 ...
 break
            ...
            let kukiw = `*Kak ${pushname}*`
	           ...
	           rows: [
                ...
                {title: "🔴 • Menu", rowId: `menu`, description: `╰ ► 📢 Thanks For Para pengguna 𝗕𝗼𝘁 𝗢𝗳𝗳𝗶𝗰𝗶𝗮𝗹 𝗡𝗮𝗶 𝗦𝘁𝗼𝗿𝗲 ♕︎`},
